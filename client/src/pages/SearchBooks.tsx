...
const SearchBooks = () => {
  ...
  // function to handle saving a book to our database using Apollo mutation
  const handleSaveBook = async (bookId: string) => {
    ...
    try {
      ...
      const { data: _data } = await saveBookMutation({
        variables: {
          book: {
      ...
      // If the book is successfully saved to the user's account, save the book id to state
